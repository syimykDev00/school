      ...
      <Container className="container">
        <SchoolFloorsClass className="schoolFloors">
          <SchoolFloorsGroup className="schoolFloorsGroup">
            ...
            <SchoolFloorsDescription>
              Отдельно стоящее здание площадью 2820 м² расположено на охраняемой
              территории
            </SchoolFloorsDescription>
          </SchoolFloorsGroup>
          <SchoolFloorsGroup className="schoolFloorsGroup">
            ...
            <SchoolFloorsDescription>
              Площадь земельного участка школы
            </SchoolFloorsDescription>
          </SchoolFloorsGroup>
          <SchoolFloorsGroup className="schoolFloorsGroup">
            <SchoolFloorsTitle>90</SchoolFloorsTitle>
            <SchoolFloorsDescription>
              Посадочных мест в школьной столовой
            </SchoolFloorsDescription>
          </SchoolFloorsGroup>
          <SchoolFloorsGroup className="schoolFloorsGroup">
            <SchoolFloorsTitle>180</SchoolFloorsTitle>
            <SchoolFloorsDescription>
              Посадочных мест в актовом зале
            </SchoolFloorsDescription>
          </SchoolFloorsGroup>
        </SchoolFloorsClass>
      </Container>
