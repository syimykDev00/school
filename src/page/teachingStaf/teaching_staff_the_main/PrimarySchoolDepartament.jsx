...
import images from "../../../assets/img_teaching_staff/Rectangle 1631.png";

const PrimarySchoolDepartament = () => {
  const people = [
    {
      id: 1,
  ...
  return (
    <Container>
      <Title>Кафедра начальной школы</Title>
      <Swiper
        modules={[Pagination]}
        spaceBetween={30}
        slidesPerView={3}
...
export default PrimarySchoolDepartament;
